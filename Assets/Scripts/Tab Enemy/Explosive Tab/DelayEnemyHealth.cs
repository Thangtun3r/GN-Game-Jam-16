...
public class DelayEnemyHealth : EnemyHealth
{
    ...
    // Override the Die method to add a delay before executing the base death logic.
    ...
    private IEnumerator DelayedDeath()
    {
        ...
        // After effects are complete, call the base Die() to handle particles, events, and pooling.
        base.Die();
    }
